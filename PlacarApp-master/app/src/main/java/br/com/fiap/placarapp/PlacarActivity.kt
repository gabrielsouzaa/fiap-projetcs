...
class PlacarActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        placarViewModel.goalAway.observe(this, Observer{ goalAway ->
            tvPlacarVisitante.text = "$goalAway"
        })
        ...
        btGolCasa.setOnClickListener {
            placarViewModel.golHome()
        }

        btGolVisitante.setOnClickListener {
            placarViewModel.golAway()
        }

        btRestartGame.setOnClickListener {
            placarViewModel.startGame()
        }
    ...
    private fun shareWhatsApp() {
        try {
            ...
            val message  = getString(R.string.message_to_share,
                    tvPlacarCasa, tvPlacarVisitante, placarViewModel.goalHome.value, placarViewModel.goalAway.value)
